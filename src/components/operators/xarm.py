...
class XarmOperator(Operator):
    ...
    def _reset_teleop(self):
        ...
        while anchors_counts < 3:
            ...
            pre_state = state
        self.hand_origin = np.array(anchors[0])
        self.hand_y = np.array(anchors[1]) - self.hand_origin
        self.hand_x = np.array(anchors[2]) - self.hand_origin
    ...
    def _apply_retargeted_angles(self):
        ...
        self.robot.move_coords(final_pose, speed=300)
